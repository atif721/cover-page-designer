...
const PDFPreview = ({
  ...
  return (
    <>
      <div className="flex-1 flex items-center justify-center p-10 overflow-auto bg-gray-200">
        <div ref={previewRef} className="a4-page text-black font-serif" style={{ width: "210mm", height: "297mm" }}>
          {/* Outer Border */}
          <div className="border-3 border-black rounded-2xl h-full w-full p-3 box-border relative">
            ...
            {/* Experiment/Assignment Name Box */}
            <div className="border-2 border-black rounded-2xl mb-10 min-h-32 text-center flex flex-col justify-self-center">
              <p className="text-lg mt-2">{type === "Lab Report" ? "Experiment Name:" : "Assignment Name:"}</p>
              <p className="text-lg font-bold capitalize">{experimentName}</p>
            </div>
